  ...
  text = ''
    ...
    main() {
      show_usage() {
        cat << 'USAGE_EOF'
╔════════════════════════════════════════════════════════════╗
║                 Lineage Config Extractor                  ║
╚════════════════════════════════════════════════════════════╝

Extract configuration from existing files and generate .lineage.toml sections
...
Options:
  ...
  --examples     Generate example .lineage.toml configurations
...
USAGE_EOF
    ...
    generate_examples() {
      echo "# Example .lineage.toml configuration"
      echo "# Generated by Lineage Config Extractor"
      echo ""
      echo "[organization]"
      echo "name = \"MyCompany\""
    ...
    auto_extract_configs() {
      ...
      if [[ -n "$OUTPUT_FILE" ]]; then
        ...
        echo "Generated .lineage.toml configuration:"
        echo "────────────────────────────────────────"
        echo "$output"
      fi
    }
