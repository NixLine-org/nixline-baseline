...
in {
  files = {
    "rustfmt.toml" = ''
      ...
      # Generated by Lineage - edit via .lineage.toml [packs."rust/rustfmt"] section
    ...
    "docs/rust-formatting.md" = ''
      ...
      The rustfmt configuration is generated from your `.lineage.toml` file.
      Current settings:
      ...
      To customize formatting rules, modify the `[packs."rust/rustfmt"]` section in `.lineage.toml`:
