# Lineage Baseline Importer
#
# Library for importing governance repositories and converting them to Lineage packs.
...
${lib.concatStringsSep "\n" configLines}''
      ...
      header = ''
        ...
        # Generated by Lineage Baseline Importer
...
${packConfigs}
  ...
  importWithConfig = governanceRepoSrc:
    let
      ...
      lineageConfig = generateNixlineConfig allPackNames governanceRepoSrc ecosystems;

      lineageTomlPack = { pkgs, lib, config ? {} }: {
        files = {
          ".lineage.toml" = lineageConfig;
        };
        checks = [
          {
            name = "lineage-config-present";
            check = ''
        ...
        meta = {
          description = "Generated Lineage configuration";
          inherit ecosystems;
